...
<?php if ($done == "1") { ?>
    ...
    <?php if ($submission_failed != "1") { ?>
        ...
        <?php } elseif ($action == "FR") { ?>
            <BR><strong>The following domains were fully renewed for <?php echo $new_renewal_years; ?>
                year<?php if ($new_renewal_years > 1) {
                    echo "s";
                } ?>:</strong><BR>
        <?php } elseif ($action == "E") { ?>
...
<?php } ?>
Instead of having to waste time editing domains one-by-one, you can use the below form to update various data for
multiple domains all at once.<BR><BR>

<form name="bulk_updater_form" method="post">
    <select name="jumpMenu" id="jumpMenu" onChange="MM_jumpMenu('parent',this,0)">
        <option value="bulk-updater.php"<?php if ($action == "") {
            echo " selected";
        } ?>>Choose Action
        </option>
        <option value="bulk-updater.php?action=AD"<?php if ($action == "AD") {
            echo " selected";
        } ?>>Add Domains
        </option>
        <option value="bulk-updater.php?action=AN"<?php if ($action == "AN") {
            echo " selected";
        } ?>>Add A Note
        </option>
        <option value="bulk-updater.php?action=FR"<?php if ($action == "FR") {
            echo " selected";
        } ?>>Renew Domains (Update Expiry Date, Mark Active, Add Note)
        </option>
        <option value="bulk-updater.php?action=R"<?php if ($action == "R") {
            echo " selected";
        } ?>>Renew Domains (Update Expiry Date Only)
        </option>
        <option value="bulk-updater.php?action=A"<?php if ($action == "A") {
            echo " selected";
        } ?>>Mark as 'Active'
        </option>
        <option value="bulk-updater.php?action=T"<?php if ($action == "T") {
            echo " selected";
        } ?>>Mark as 'In Transfer'
        </option>
        <option value="bulk-updater.php?action=PRg"<?php if ($action == "PRg") {
            echo " selected";
        } ?>>Mark as 'Pending (Registration)'
        </option>
        <option value="bulk-updater.php?action=PRn"<?php if ($action == "PRn") {
            echo " selected";
        } ?>>Mark as 'Pending (Renewal)'
        </option>
        <option value="bulk-updater.php?action=PO"<?php if ($action == "PO") {
            echo " selected";
        } ?>>Mark as 'Pending (Other)'
        </option>
        <option value="bulk-updater.php?action=E"<?php if ($action == "E") {
            echo " selected";
        } ?>>Mark as 'Expired'
        </option>
        <option value="bulk-updater.php?action=S"<?php if ($action == "S") {
            echo " selected";
        } ?>>Mark as 'Sold'
        </option>
        <option value="bulk-updater.php?action=PRVE"<?php if ($action == "PRVE") {
            echo " selected";
        } ?>>Mark as Private WHOIS
        </option>
        <option value="bulk-updater.php?action=PRVD"<?php if ($action == "PRVD") {
            echo " selected";
        } ?>>Mark as Public WHOIS
        </option>
        <option value="bulk-updater.php?action=CPC"<?php if ($action == "CPC") {
            echo " selected";
        } ?>>Change Category
        </option>
        <option value="bulk-updater.php?action=CDNS"<?php if ($action == "CDNS") {
            echo " selected";
        } ?>>Change DNS Profile
        </option>
        <option value="bulk-updater.php?action=CED"<?php if ($action == "CED") {
            echo " selected";
        } ?>>Change Expiry Date
        </option>
        <option value="bulk-updater.php?action=CIP"<?php if ($action == "CIP") {
            echo " selected";
        } ?>>Change IP Address
        </option>
        <option value="bulk-updater.php?action=CRA"<?php if ($action == "CRA") {
            echo " selected";
        } ?>>Change Registrar Account
        </option>
        <option value="bulk-updater.php?action=CWH"<?php if ($action == "CWH") {
            echo " selected";
        } ?>>Change Web Hosting Provider
        </option>
        <option
            value="bulk-updater.php?action=UCF"<?php if ($action == "UCF" || $action == "UCF1" || $action == "UCF2" || $action == "UCF3") {
            echo " selected";
        } ?>>Update Custom Domain Field
        </option>
        <option value="bulk-updater.php?action=DD"<?php if ($action == "DD") {
            echo " selected";
        } ?>>Delete Domains
        </option>
    </select>
    ...
    <?php if ($action == "UCF" || $action == "UCF1" || $action == "UCF2" || $action == "UCF3") { ?>
        ...
        <select name="jumpMenu" id="jumpMenu2" onChange="MM_jumpMenu('parent',this,0)">
            <option value="bulk-updater.php?action=UCF"<?php if ($action == "UCF") {
                echo " selected";
            } ?>>Choose the Custom Field to Edit
            </option>
            <?php
            ...
            while ($row = mysqli_fetch_object($result)) { ?>
                ...
                <option value="bulk-updater.php?action=UCF<?php echo $row->type_id; ?>&field_id=<?php echo $row->id; ?>"<?php if ($row->id == $field_id) echo " selected"; ?>><?php echo $row->name; ?>
                (<?php echo $row->type; ?>)</option><?php
    ...
    <?php if ($action == "R" || $action == "FR") { ?>
        ...
        <select name="new_renewal_years">
            ...
            <option value="2"<?php if ($new_renewal_years == "2") {
                echo " selected";
            } ?>>2 Years
            </option>
            <option value="3"<?php if ($new_renewal_years == "3") {
                echo " selected";
            } ?>>3 Years
            </option>
            <option value="4"<?php if ($new_renewal_years == "4") {
                echo " selected";
            } ?>>4 Years
            </option>
            <option value="5"<?php if ($new_renewal_years == "5") {
                echo " selected";
            } ?>>5 Years
            </option>
            <option value="6"<?php if ($new_renewal_years == "6") {
                echo " selected";
            } ?>>6 Years
            </option>
            <option value="7"<?php if ($new_renewal_years == "7") {
                echo " selected";
            } ?>>7 Years
            </option>
            <option value="8"<?php if ($new_renewal_years == "8") {
                echo " selected";
            } ?>>8 Years
            </option>
            <option value="9"<?php if ($new_renewal_years == "9") {
                echo " selected";
            } ?>>9 Years
            </option>
            <option value="10"<?php if ($new_renewal_years == "10") {
                echo " selected";
            } ?>>10 Years
            </option>
        </select>
    ...
    <?php } elseif ($action == "UCF1") {
        ...
        while ($row = mysqli_fetch_object($result)) { ?>
            ...
            <input type="checkbox" name="new_<?php echo $row->field_name; ?>"
                   value="1"<?php if (${'new_' . $field} == "1") echo " checked"; ?>><BR><?php
        ...
        while ($row = mysqli_fetch_object($result)) { ?>
            ...
            <input type="text" name="new_<?php echo $row->field_name; ?>" size="50" maxlength="255"
                   value="<?php echo ${'new_' . $row->field_name}; ?>"><BR><BR><?php
        ...
        while ($row = mysqli_fetch_object($result)) { ?>
            ...
            <textarea name="new_<?php echo $row->field_name; ?>" cols="60"
                      rows="5"><?php echo ${'new_' . $row->field_name}; ?></textarea><BR><BR><?php
                ...
                foreach ($field_array as $field) {
                    ...
                    while ($row = mysqli_fetch_object($result)) {
                        ...
                        if ($row->type_id == "1") { // Check Box ?>
                            ...
                            <input type="checkbox" name="new_<?php echo $row->field_name; ?>"
                                   value="1"<?php if (${'new_' . $field} == "1") echo " checked"; ?>>
