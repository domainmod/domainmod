...
echo $form->showInputText('new_expiration_email_days', 'Days to Display in Expiration Emails', 'This is the number of days in the future to display in the expiration emails.', $new_expiration_email_days, '3', '', '', '');
