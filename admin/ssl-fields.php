...
<table class="main_table" cellpadding="0" cellspacing="0">
    ...
    while ($row = mysqli_fetch_object($result)) { ?>
        ...
        <td class="main_table_cell_active">
            <a class="invisiblelink"
               href="edit/ssl-field.php?csfid=<?php echo $row->id; ?>"><?php echo $time->toUserTimezone($row->insert_time); ?></a>
        </td>
        <td class="main_table_cell_active">
            <?php
            ...
            ?>
            <a class="invisiblelink"
               href="edit/ssl-field.php?csfid=<?php echo $row->id; ?>"><?php echo $time->toUserTimezone($temp_update_time); ?></a>
        </td>
        </tr><?php
    }
