...
if (mysqli_num_rows($result) == 0) {
    ...
    $_SESSION['s_result_message'] .= "You're trying to edit an invalid Custom SSL Field<BR>";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $new_name != "") {
    ...
    $_SESSION['s_result_message'] .= "Custom SSL Field <div class=\"highlight\">" . $new_name . " (" . $temp_field_name . ")</div> Updated<BR>";
...
if ($del == "1") {
    ...
    $_SESSION['s_result_message'] = "Are you sure you want to delete this Custom SSL Field?<BR><BR><a href=\"ssl-field.php?csfid=" . $csfid . "&really_del=1\">YES, REALLY DELETE THIS CUSTOM SSL FIELD</a><BR>";
...
if ($really_del == "1") {
    ...
    if ($csfid == "") {
        ...
        $_SESSION['s_result_message'] = "The Custom SSL Field cannot be deleted<BR>";
        ...
        $_SESSION['s_result_message'] = "Custom SSL Field <div class=\"highlight\">" . $temp_name . " (" . $temp_field_name . ")</div> Deleted<BR>";
