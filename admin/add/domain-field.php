...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $new_name != "" && $new_field_name != "" &&
    ...
    if ($q->prepare($query)) {
        ...
        if ($q->num_rows() > 0) {
            ...
            $_SESSION['s_result_message'] .= "Custom Domain Field <div class=\"highlight\">" . $new_name . " (" .
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!$custom_field->checkFieldFormat($new_field_name)) $_SESSION['s_result_message'] .=
...
<form name="add_domain_field_form" method="post">
    ...
    <strong>Database Field Name (30)</strong><a title="Required Field">
        <div
    ...
    <div class="default_highlight">WARNING:</div>
    The Database Field Name cannot be renamed.<BR><BR><input
        name="new_field_name" type="text" size="20" maxlength="30" value="<?php echo $new_field_name; ?>"><BR><BR>
    <strong>Data Type</strong><BR><BR>

    <div class="default_highlight">WARNING:</div>
    The Data Type cannot be changed.<BR><BR>
    <?php
