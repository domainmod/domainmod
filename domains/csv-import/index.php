    ...
    try {
        ...
        if (isset($_FILES["file"])) {
            ...
            if (!$upload->upload()) {
                ...
                $_SESSION['s_message_danger'] .= _('Please choose a CSV template file to import (import.csv)');
...
<a href='../../import.csv'><?php echo _('Click here'); ?></a> <?php echo _('to download the CSV Import Template.'); ?> <?php echo sprintf(_('You can import as little or as much domain information as you want.')); ?>&nbsp;<?php echo sprintf(_('Technically you can fill in nothing but a list of domains, and it will import just fine, but DomainMOD will need to create a bunch of generic assets for you. It\'s ok though, even if you go this route it\'s pretty easy to update the information that %s creates for you.'), SOFTWARE_TITLE); ?>
