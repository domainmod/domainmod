...
class DwDisplay
{
    ...
    public function account($connection, $server_id, $domain, $show_sidebar, $show_domain, $show_zone)
    {
        ...
        $result_account = mysqli_query($connection, $sql);
        ...
        while ($row = mysqli_fetch_object($result_account)) {
            ...
            <tr class="main_table_row_active_no_hover"><?php
                ...
                if ($show_sidebar == '1') {
                    ...
                    echo $this->sidebar($domain, $server_id, $row->server_name, $show_domain, $show_zone);
                ...
                <td class="main_table_cell_active_top_aligned">
                    ...
                    <strong>HD
                        Quota:</strong> <?php echo $row->disklimit; ?>
                        <?php if ($row->disklimit != "unlimited") echo " MB"; ?>
                        <BR>
    ...
    public function sidebar($domain, $server_id, $server_name, $show_domain, $show_zone)
    {
        ...
        <td class="main_table_cell_active_top_aligned"><?php
            ...
            if ($show_domain == '1') { ?>
                <strong><?php echo $visible_domain; ?></strong><BR><BR><?php
            }
            ...
            if ($show_zone == '1') { ?>
                ...
                [<a class="covert_link" href="list-dns-zones.php?domain=<?php echo $domain; ?>&server_id=<?php echo
                $server_id; ?>">dns zone</a>]<?php
