...
Before running any reports you should <a href="<?=$web_root?>//system/update-conversion-rates.php">update the conversion rates</a>.<BR><BR>
<font class="subheadline">List of Available Reports</font><BR><BR>
<select name="reporting_menu" onChange="MM_jumpMenu('parent',this,0)">
<option value="<?=$web_root?>/reporting/"<?php if ($report_name == "") echo " selected" ?>>Choose the Report to Run</option>
...
<option value="<?=$web_root?>/reporting/domains/tld-breakdown.php"<?php if ($report_name == "tld-breakdown") echo " selected" ?>>Domains &raquo; TLD Breakdown</option>
