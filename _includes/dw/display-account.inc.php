    ...
    while ($row_dw_account_temp = mysqli_fetch_object($result_dw_account_temp)) {
        ...
        if ($from_main_dw_account_page == 1) { ?>
            ...
            while ($row_zone = mysqli_fetch_object($result_zone)) { ?>
                ...
                <BR>[<a class="covert_link"
                        href="list-dns-zones.php?domain=<?php echo $row_dw_account_temp->domain; ?>">dns zone</a>]<?php
        ...
        <td>
            ...
            <?php if ($from_main_dw_account_page == 0) { ?>
                <div
                    class="default_highlight"><?php echo $row_dw_account_temp->dw_server_name; ?></div><BR>
                <BR><?php } ?>
            <table class="main_table" cellpadding="0" cellspacing="0">
                <tr class="main_table_row_active_no_hover">
                    <td class="main_table_cell_active_top_aligned">
                        <strong>Created:</strong> <?php echo date("Y M jS", $row_dw_account_temp->unix_startdate); ?>
                        <BR>
                        ...
                        <strong>User, Owner:</strong> <?php echo $row_dw_account_temp->user; ?>
                        , <?php echo $row_dw_account_temp->owner; ?>
                    </td>
                    <td class="main_table_cell_active_top_aligned">
                        <strong>Shell:</strong> <?php echo $row_dw_account_temp->shell; ?><BR>
                        <strong>Home:</strong> /<?php echo $row_dw_account_temp->partition; ?>
                        /<?php echo $row_dw_account_temp->user; ?><BR>
                        <strong>HD
                            Quota:</strong> <?php echo $row_dw_account_temp->disklimit; ?><?php if ($row_dw_account_temp->disklimit != "unlimited") echo " MB"; ?>
                        <BR>
