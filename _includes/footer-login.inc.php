...
<table align="center" width="<?=$site_width?>" border="0" cellspacing="0" cellpadding="0">
	<tr>
        <td class="footer-table-login" height="100%">
            <BR><?=$software_title?> is free software created by <a target="_blank" class="subtlelink" href="http://chetcuti.com">Greg Chetcuti</a> and released under the GNU/GPL License.<br>
