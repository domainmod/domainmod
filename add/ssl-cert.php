...
if ($q->prepare($query)) {
    ...
    while ($q->fetch()) { ?>
        ...
        <option value="<?php echo $id; ?>"<?php if ($id == $to_compare) echo " selected";?>><?php echo $name; ?> (<?php
            echo $ip; ?>)</option><?php
            ...
            if ($q_cf->prepare($query_cf)) {
                ...
                while ($q_cf->fetch()) {
                    ...
                    if ($type_id == "1") { // Check Box ?>
                        ...
                        <input type="text" name="new_<?php echo $field_name; ?>" size="50" maxlength="255" value="<?php
