...
<table class="main_table" cellpadding="0" cellspacing="0">
    <tr class="main_table_row_heading_active">
        <td class="main_table_cell_heading_active">
            <div class="main_table_heading">Active SSL Types (<?php echo mysqli_num_rows($result); ?>)</div>
        </td>
        <td class="main_table_cell_heading_active">
    ...
    while ($row = mysqli_fetch_object($result)) {
        ...
        <td class="main_table_cell_active"><?php
            ...
            if ($active_certs == "0") {
                ...
                <a class="nobold" href="../ssl-certs.php?ssltid=<?php echo $row->id; ?>"><?php echo number_format
                ($active_certs); ?></a><?php
    ...
    if ($_SESSION['display_inactive_assets'] == "1") {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            <td class="main_table_cell_heading_inactive">
                <div class="main_table_heading">Inactive SSL Types (<?php echo mysqli_num_rows($result); ?>)</div>
            </td>
            </tr><?php
    ...
    if ($has_active || $has_inactive) { ?>
        <BR>
        <div class="default_highlight">*</div> = Default SSL Type<?php
    }
