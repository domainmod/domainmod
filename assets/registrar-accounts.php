...
if ($export == "1") {
	...
	$full_export .= "\"Status\",\"Registrar\",\"Username\",\"Password\",\"Owner\",\"Domains\",\"Default Account?\",\"Reseller Account?\",\"Notes\",\"Added\",\"Last Updated\"\n";
	...
	if (mysql_num_rows($result) > 0) {
		...
		while ($row = mysql_fetch_object($result)) { 
			...
			$full_export .= "\"Active\",\"" . $row->rname . "\",\"" . $row->username . "\",\"" . $row->password . "\",\"" . $row->oname . "\",\"" . $total_domain_count . "\",\"" . $is_default . "\",\"" . $is_reseller . "\",\"" . $row->notes . "\",\"" . $row->insert_time . "\",\"" . $row->update_time . "\"\n";
	...
	if (mysql_num_rows($result) > 0) { 
		...
		while ($row = mysql_fetch_object($result)) {
			...
			$full_export .= "\"Inactive\",\"" . $row->rname . "\",\"" . $row->username . "\",\"" . $row->password . "\",\"" . $row->oname . "\",\"0\",\"" . $is_default . "\",\"" . $is_reseller . "\",\"" . $row->notes . "\",\"" . $row->insert_time . "\",\"" . $row->update_time . "\"\n";
