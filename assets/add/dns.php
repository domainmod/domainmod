...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($new_name != '' && $new_dns1 != "" && $new_dns2 != "") {
		...
		$sql = "INSERT INTO dns 
				...
				('" . mysqli_real_escape_string($new_name) . "', '" . mysqli_real_escape_string($new_dns1) . "', '" . mysqli_real_escape_string($new_dns2) . "', '" . mysqli_real_escape_string($new_dns3) . "', '" . mysqli_real_escape_string($new_dns4) . "', '" . mysqli_real_escape_string($new_dns5) . "', '" . mysqli_real_escape_string($new_dns6) . "', '" . mysqli_real_escape_string($new_dns7) . "', '" . mysqli_real_escape_string($new_dns8) . "', '" . mysqli_real_escape_string($new_dns9) . "', '" . mysqli_real_escape_string($new_dns10) . "', '" . mysqli_real_escape_string($new_ip1) . "', '" . mysqli_real_escape_string($new_ip2) . "', '" . mysqli_real_escape_string($new_ip3) . "', '" . mysqli_real_escape_string($new_ip4) . "', '" . mysqli_real_escape_string($new_ip5) . "', '" . mysqli_real_escape_string($new_ip6) . "', '" . mysqli_real_escape_string($new_ip7) . "', '" . mysqli_real_escape_string($new_ip8) . "', '" . mysqli_real_escape_string($new_ip9) . "', '" . mysqli_real_escape_string($new_ip10) . "', '" . mysqli_real_escape_string($new_notes) . "', '" . $new_number_of_servers . "', '" . $current_timestamp . "')";
