...
if ($export_data == "1") {
    ...
    $export_file = $export->openFile('web_hosting_provider_list', strtotime($time->time()));
...
<table class="main_table" cellpadding="0" cellspacing="0">
    ...
    if ($_SESSION['display_inactive_assets'] != "1") { //@formatter:on ?>
    ...
    if ($has_active || $has_inactive) { ?>
        <BR>
        <div class="default_highlight">*</div> = Default Web Host<?php
    }
