...
<form name="export_domains_form" method="post">
    ...
    <?php if ($total_rows > 0) { //@formatter:off ?>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>[<a href="cost-by-tld.php?export_data=1&new_start_date=<?php
...
if ($submission_failed != "1" && $total_rows > 0) { ?>
    ...
    while ($row = mysqli_fetch_object($result)) {
        ...
        <td class="main_table_cell_active">
            <a class="invisiblelink" href="../../domains.php?tld=<?php echo $row->tld; ?>">.<?php echo $row->tld; ?></a>
        </td>
        <td class="main_table_cell_active">
            <a class="invisiblelink" href="../../domains.php?tld=<?php echo $row->tld; ?>"><?php
