...
require_once DIR_INC . '/settings/reporting-domain-cost-by-dns.inc.php';
...
$result = $pdo->query("
    SELECT dns.id, dns.name, SUM(d.total_cost * cc.conversion) AS total_cost, count(*) AS number_of_domains
...
if ($submission_failed != '1' && $total_rows > 0) {
    ...
    if ($export_data === 1) {
        ...
        if ($daterange == '') {
            ...
            $export_file = $export->openFile(_('domain_cost_by_dns_report_all'), strtotime($time->stamp()));

        } else {

            $export_file = $export->openFile(
                _('domain_cost_by_dns_report'),
    ...
    <table id="<?php echo $slug; ?>" class="<?php echo $datatable_class; ?>">
        ...
        foreach ($result as $row) {
            ...
            <tr>
                ...
                <td><a href="../../domains/index.php?dnsid=<?php echo $row->id; ?>"><?php echo $row->number_of_domains; ?></a></td>
