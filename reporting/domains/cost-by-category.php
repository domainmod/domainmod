...
if ($submission_failed != "1" && $total_rows > 0) {
	...
	if ($export_data == "1") {
        ...
        if ($all == "1") {
            ...
            $export_file = $export->openFile('domain_cost_by_category_report_all');
...
<?php include(DIR_INC . "layout/table-export-top.inc.php"); ?>
    <form name="export_domains_form" method="post" action="cost-by-category.php">
...
if ($submission_failed != "1" && $total_rows > 0) { ?>
	...
	while ($row = mysqli_fetch_object($result)) {
		...
		<tr class="main_table_row_active">
			...
			<td class="main_table_cell_active"><a class="invisiblelink" href="../../domains.php?pcid=<?php echo $row->id; ?>"><?php echo $row->number_of_domains; ?></a></td>
