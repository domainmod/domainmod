...
if ($submission_failed != "1" && $total_rows > 0) { ?>
    ...
    <tr class="main_table_row_heading_active">
        <td class="main_table_cell_heading_active">
            <div class="main_table_heading">Owner</div></td>
        <td class="main_table_cell_heading_active">
    ...
    while ($row = mysqli_fetch_object($result)) {
        ...
        <td class="main_table_cell_active">
            <a class="invisiblelink" href="../../domains.php?oid=<?php echo $row->id; ?>"><?php echo $row->name; ?></a>
        </td>
        <td class="main_table_cell_active">
            <a class="invisiblelink" href="../../domains.php?oid=<?php echo $row->id; ?>"><?php
