...
$sql = "SELECT ip.id, ip.name, ip.ip, ip.rdns, SUM(f.renewal_fee * cc.conversion) AS total_cost, count(*) AS number_of_domains
...
if ($submission_failed != "1" && $total_rows > 0) { ?>
	...
	while ($row = mysql_fetch_object($result)) {
		...
		<tr class="main_table_row_active">
			<td class="main_table_cell_active"><a class="invisiblelink" href="../../domains.php?ipid=<?=$row->id?>"><?=$row->name?></a></td>
			<td class="main_table_cell_active"><a class="invisiblelink" href="../../domains.php?ipid=<?=$row->id?>"><?=$row->ip?></a></td>
			<td class="main_table_cell_active"><a class="invisiblelink" href="../../domains.php?ipid=<?=$row->id?>"><?=$row->rdns?></a></td>
			<td class="main_table_cell_active"><a class="invisiblelink" href="../../domains.php?ipid=<?=$row->id?>"><?=$row->number_of_domains?></a></td>
