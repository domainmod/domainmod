...
$sql = "SELECT o.id, o.name, SUM(f.renewal_fee * cc.conversion) as total_cost, count(*) AS number_of_certs
...
if ($submission_failed != "1" && $total_rows > 0) {
	...
	if ($export == "1") {
		...
		$full_export .= "\"Owner\",\"SSL Certs\",\"Cost\",\"Per Cert\"\n";
...
if ($submission_failed != "1" && $total_rows > 0) { ?>
	...
	while ($row = mysql_fetch_object($result)) {
		...
		<tr class="main_table_row_active">
			<td class="main_table_cell_active"><a class="invisiblelink" href="../../ssl-certs.php?oid=<?=$row->id?>"><?=$row->name?></a></td>
			<td class="main_table_cell_active"><a class="invisiblelink" href="../../ssl-certs.php?oid=<?=$row->id?>"><?=$row->number_of_certs?></a></td>
