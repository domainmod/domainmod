...
if ($submission_failed != "1" && $total_rows > 0) {
    ...
    if ($export_data == "1") {
        ...
        if ($all == "1") {
            ...
            $export_file = $export->openFile('ssl_cost_by_domain_report_all', strtotime($time->stamp()));
...
<form name="export_ssl_form" method="post">
    ...
    <?php if ($total_rows > 0) { //@formatter:off ?>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>[<a href="cost-by-domain.php?export_data=1&new_start_date=<?php
...
if ($submission_failed != "1" && $total_rows > 0) { ?>
    ...
    while ($row = mysqli_fetch_object($result)) {
        ...
        <td class="main_table_cell_active">
            <a class="invisiblelink" href="../../ssl-certs.php?did=<?php echo $row->id; ?>"><?php
                echo $row->domain; ?></a>
        </td>
        <td class="main_table_cell_active">
            <a class="invisiblelink" href="../../ssl-certs.php?did=<?php echo $row->id; ?>"><?php
