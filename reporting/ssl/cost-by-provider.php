...
if ($submission_failed != "1" && $total_rows > 0) {
    ...
    if ($export_data == "1") {
        ...
        if ($all == "1") {
            ...
            $export_file = $export->openFile('ssl_cost_by_provider_report_all', strtotime($time->time()));
...
if ($submission_failed != "1" && $total_rows > 0) { ?>
    ...
    <tr class="main_table_row_heading_active">
        <td class="main_table_cell_heading_active">
            <div class="main_table_heading">Provider</div>
        </td>
        <td class="main_table_cell_heading_active">
        ...
        <td class="main_table_cell_heading_active">
            <div class="main_table_heading">Provider Account</div>
        </td>
        <td class="main_table_cell_heading_active">
            <div class="main_table_heading">Certs</div>
        </td>
