...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ((!$date->checkDateFormat($new_start_date) || !$date->checkDateFormat($new_end_date)) || $new_start_date >
        ...
        if (!$date->checkDateFormat($new_start_date)) $_SESSION['s_result_message'] .= "The starting date is invalid<BR>";
        if (!$date->checkDateFormat($new_end_date)) $_SESSION['s_result_message'] .= "The ending date is invalid<BR>";
        if ($new_start_date > $new_end_date) $_SESSION['s_result_message'] .= "The ending date proceeds the starting date<BR>";
