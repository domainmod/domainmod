...
<form name="export_ssl_form" method="post">
    ...
    <?php if ($total_rows > 0) { //@formatter:off ?>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>[<a href="cost-by-category.php?export_data=1&new_start_date=<?php
...
if ($submission_failed != "1" && $total_rows > 0) { ?>
    ...
    <tr class="main_table_row_heading_active">
        <td class="main_table_cell_heading_active">
            <div class="main_table_heading">Category</div></td>
        <td class="main_table_cell_heading_active">
            <div class="main_table_heading">SSL Certs</div></td>
        <td class="main_table_cell_heading_active">
    ...
    while ($row = mysqli_fetch_object($result)) {
        ...
        <td class="main_table_cell_active">
            <a class="invisiblelink" href="../../ssl-certs.php?sslpcid=<?php echo $row->id; ?>"><?php
                echo $row->name; ?></a>
        </td>
        <td class="main_table_cell_active">
            <a class="invisiblelink" href="../../ssl-certs.php?sslpcid=<?php echo $row->id; ?>"><?php
