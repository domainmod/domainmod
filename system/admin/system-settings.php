...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $new_email_address != "") {
	...
	$_SESSION['session_result_message'] .= "If you changed the system's default currency you should <a href=\"update-conversion-rates.php\">click here to update the conversion rates</a>.<BR>";
