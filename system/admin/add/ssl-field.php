<?php
/**
 * /system/admin/add/ssl-field.php
 *
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $new_name != "" && $new_field_name != "" && $custom_field->checkFieldFormat($new_field_name)) {
    ...
    if ($existing_field_name == 1) {
        ...
        $sql = "INSERT INTO ssl_cert_fields
                ...
                ('" . mysqli_real_escape_string($connection, $new_name) . "', '" . mysqli_real_escape_string($connection, $new_field_name) . "', '" . mysqli_real_escape_string($connection, $new_description) . "', '" . $new_field_type_id . "', '" . mysqli_real_escape_string($connection, $new_notes) . "', '" . $time->time() . "')";
